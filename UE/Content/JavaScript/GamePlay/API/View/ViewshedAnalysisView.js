...
exports.ViewshedAnalysisView = void 0;
const UE = require("ue");
const puerts_1 = require("puerts");
const BaseView_1 = require("../../../System/API/View/BaseView");
const Game_APIList_1 = require("../Game_APIList");
...
class ViewshedAnalysisView extends BaseView_1.BaseView {
    //@C++
    Root;
    SceneCapture;
    Decal;
    ...
    Constructor() {
        ...
        this.Root = this.CreateDefaultSubobjectGeneric("Root", UE.StaticMeshComponent.StaticClass());
    ...
    ReceiveEndPlay(EndPlayReason) {
        ...
        Game_APIList_1.AxesTool.CloseAxesTool("");
    }
    RefreshView(jsonData) {
        ...
        if (this.data.IsAuto) {
            ...
            if (this.data.IsAuto !== this.IsAuto) {
                ...
                NotifiStyle.RegisterFrameStyle(MessageList_1.MessageTips.API.ViewshedAnalysis, 600, 3, false);
    ...
    SetInit(location) {
        ...
        this.SetMaterialColor();
        Game_APIList_1.AxesTool.OpenAxesTool("");
        this.IsExist = true;
    }
    SetComponent() {
...
exports.ViewshedAnalysisView = ViewshedAnalysisView;
//# sourceMappingURL=ViewshedAnalysisView.js.map