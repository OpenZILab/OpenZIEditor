...
exports.HeatMapView = void 0;
const UE = require("ue");
const ue_1 = require("ue");
const puerts_1 = require("puerts");
const BaseView_1 = require("../../../System/API/View/BaseView");
class HeatMapView extends BaseView_1.BaseView {
    //@C++
    Root;
    ...
    Constructor() {
        ...
        this.HeatMap = this.CreateDefaultSubobjectGeneric("HeatMap", UE.StaticMeshComponent.StaticClass());
        ...
        this.UECoorList = (0, ue_1.NewArray)(UE.Vector);
        this.max_x = 0;
        this.min_x = 0;
        this.max_y = 0;
        this.min_y = 0;
    ...
    RefreshView(jsonData) {
        ...
        let FHitResult2 = (0, puerts_1.$ref)(new UE.HitResult);
...
//# sourceMappingURL=HeatMapView.js.map