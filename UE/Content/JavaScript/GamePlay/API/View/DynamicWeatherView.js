...
exports.DynamicWeatherView = void 0;
const UE = require("ue");
...
;
class DynamicWeatherView extends BaseView_1.BaseView {
    //@ts
    data;
    jsondata;
    callback;
    ...
    ReceiveBeginPlay() {
        ...
        MessageManager_1.MessageCenter.Add(this, this.UpdataSunTileAngle, NotificationLists_1.NotificationLists.API.ON_PAWN_CENTER_SPHERE);
    }
    ...
    ReceiveEndPlay(EndPlayReason) {
        ...
        MessageManager_1.MessageCenter.Remove(this, NotificationLists_1.NotificationLists.API.ON_PAWN_CENTER_SPHERE);
    }
    //时间变换
    ChangeHour(DayTime) {
    ...
    SetSunAndMoonRotation() {
        ...
        this.ConvertAngleToTime(this.SunTiltAngle, this.SunRotatAngle, this.SunRotatAngle, temp1, (0, puerts_1.$ref)(tempSun));
        let FHitResult = (0, puerts_1.$ref)(new UE.HitResult);
        ...
        this.ConvertAngleToTime(this.MoonTiltAngle, this.MoonRotatAngle, this.MoonRotatAngle, temp2, (0, puerts_1.$ref)(tempMoon));
    ...
    SaveConfiguration() {
        ...
        let FilePath = (0, puerts_1.$unref)(CurPath) + "/Content/SkyConfig/" + this.save_B + ".json";
...
exports.DynamicWeatherView = DynamicWeatherView;
//# sourceMappingURL=DynamicWeatherView.js.map