...
exports.PolygonTriangulationAreaSum = exports.VertexConversionUVs = exports.PointInTriangle = exports.LineSegIntersectionTest = exports.RecursiveTriangulate = exports.FlipPoligon = exports.LoopArrayIndex = exports.TriangulationOfPolygon = void 0;
const UE = require("ue");
function TriangulationOfPolygon(Vertices) {
    ...
    let R = [Triangles, curnormal];
    return R;
}
exports.TriangulationOfPolygon = TriangulationOfPolygon;
function LoopArrayIndex(Index, Shift, ArrayLength) {
    let num = Index + Shift;
    let Return = num % ArrayLength;
    return Return;
}
exports.LoopArrayIndex = LoopArrayIndex;
function FlipPoligon(Vert) {
    let CurValue = 0.0;
    let Returnvalue = [];
...
exports.FlipPoligon = FlipPoligon;
function RecursiveTriangulate(Vert, FullSetVert, BuiltSeg, Thread) {
    let Seq = [];
    let TempIs;
...
exports.RecursiveTriangulate = RecursiveTriangulate;
function LineSegIntersectionTest(Poi1, Poi2, Poi3, Poi4, IgnoreSide) {
...
exports.LineSegIntersectionTest = LineSegIntersectionTest;
function PointInTriangle(Poi1, Poi2, Poi3, Poi4, IgnoreSide) {
...
//# sourceMappingURL=TriangulateHandle.js.map