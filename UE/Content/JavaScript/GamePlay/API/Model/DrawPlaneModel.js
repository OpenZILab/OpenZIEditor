...
exports.DrawPlaneModel = void 0;
const BaseModel_1 = require("../../../System/API/Model/BaseModel");
class DrawPlaneModel extends BaseModel_1.BaseModel {
    constructor() {
        super();
        this.DefaultData = {
            id: "Draw_id",
...
exports.DrawPlaneModel = DrawPlaneModel;
//# sourceMappingURL=DrawPlaneModel.js.map