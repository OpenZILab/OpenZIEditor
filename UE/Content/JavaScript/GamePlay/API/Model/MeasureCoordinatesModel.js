...
exports.MeasureCoordinatesModel = void 0;
const BaseModel_1 = require("../../../System/API/Model/BaseModel");
class MeasureCoordinatesModel extends BaseModel_1.BaseModel {
    constructor() {
        super();
        this.DefaultData = {
            id: "Measure_id",
...
exports.MeasureCoordinatesModel = MeasureCoordinatesModel;
//# sourceMappingURL=MeasureCoordinatesModel.js.map