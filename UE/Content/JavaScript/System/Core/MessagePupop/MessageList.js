...
exports.SetMessageLanguage = exports.MessageTips = exports.language = void 0;
...
exports.MessageTips = MessageTips_cn;
function SetMessageLanguage(lan) {
    if (lan == language.cn) {
        exports.MessageTips = MessageTips_cn;
    }
    else if (lan == language.en) {
        exports.MessageTips = MessageTips_en;
    }
}
exports.SetMessageLanguage = SetMessageLanguage;
