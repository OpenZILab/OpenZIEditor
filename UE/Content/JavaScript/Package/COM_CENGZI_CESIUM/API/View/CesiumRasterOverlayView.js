...
exports.CesiumRasterOverlayView = void 0;
const UE = require("ue");
class CesiumRasterOverlayView {
    Type;
    Obj;
    Override;
    TerrianId;
    constructor(_type, _obj) {
        this.Obj = _obj;
        this.Type = _type;
        this.TerrianId = "";
        if (this.Type == "TMS") {
...
exports.CesiumRasterOverlayView = CesiumRasterOverlayView;
//# sourceMappingURL=CesiumRasterOverlayView.js.map