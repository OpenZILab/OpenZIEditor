...
call Task\WriteVersionInfo.bat %*
...
if %ERRORLEVEL% neq 0 goto Exit
REM pause
call Task\PackageProject.bat %*
if %ERRORLEVEL% neq 0 goto Exit

call Task\CopyFiles.bat %*
if %ERRORLEVEL% neq 0 goto Exit

call Task\CopyJavaScript.bat %*
if %ERRORLEVEL% neq 0 goto Exit

call Task\ModifyInformation.bat %*
if %ERRORLEVEL% neq 0 goto Exit

call Task\UpdateCproject.bat %*
if %ERRORLEVEL% neq 0 goto Exit
