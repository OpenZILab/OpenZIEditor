...
function initItem(ul, data, off = 10) {
    ...
    if (data.itemList) {
        ...
        for (let i in data) {
            let li = document.createElement("li");
            li.innerHTML = `<div  class="title_box list_list" style="padding-left: ${off}px;">${i}<img class="title_img" src="./images/123.png" alt=""></div>`;
...
function gradeChange() {
    ...
    document.querySelectorAll(".hide_btn")[0].style.color = color;
