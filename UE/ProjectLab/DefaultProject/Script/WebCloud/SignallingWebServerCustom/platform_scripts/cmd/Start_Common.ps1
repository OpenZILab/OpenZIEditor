...
$global:PublicIP = "223.85.216.88"
$global:StunServer = "223.85.216.88:19310"
$global:TurnServer = "223.85.216.88:19311"
$global:CirrusName = "cirrus"
...
function use_args($arg) {
 ...
 while($CmdArgs.count -gt 0) {
  ...
  if ($Cmd -eq "--stun") {
   ...
   $global:TurnServer = $global:publicip + ":19303"
  } elseif ($Cmd -eq "--cirrusname") {
   $global:CirrusName, $CmdArgs = $CmdArgs
  } elseif ($Cmd -eq "--help") {
   print_usage
  } else {
