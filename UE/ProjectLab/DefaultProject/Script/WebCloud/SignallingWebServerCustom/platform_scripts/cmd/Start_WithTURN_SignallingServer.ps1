...
set_start_default_values "n" "n" # Set both TURN and STUN server defaults
use_args($args)
print_parameters
...
$Arguments = @("$global:CirrusName", "--peerConnectionOptions=""$peerConnectionOptions""", "--PublicIp=$global:PublicIp")
