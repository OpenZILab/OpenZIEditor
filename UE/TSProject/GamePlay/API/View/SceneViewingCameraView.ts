...
import {SceneViewingUIView} from "./SceneViewingUIView";
import {SceneViewingView} from "./SceneViewingView";
import {$ref} from "puerts";

export class SceneViewingCameraView extends BaseView {

    //@C++
    Root: UE.SceneComponent
    CameraMesh: UE.StaticMeshComponent
    ...
    bselect: boolean
    Index: number
    SplinePointType: number
    ATangent: UE.Vector
    LTangent: UE.Vector
    RootUI: SceneViewingUIView
    ...
    SetOwnerActor(Owner: SceneViewingView) {
        this.Onwer = Owner
    }

    SetSplinePointInfo(location: UE.Vector, Rotiton: UE.Rotator, Index: number, SplinePointType: UE.ESplinePointType, ATangent: UE.Vector, LTangent: UE.Vector) {
        this.Index = Index
    ...
    CreatCameraMesh(location: UE.Vector, Rotiton: UE.Rotator) {
        let name = "CameraMesh"
